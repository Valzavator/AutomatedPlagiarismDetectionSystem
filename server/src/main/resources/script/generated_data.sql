...
INSERT INTO programming_languages(programming_language_id, name, default_comparison_sensitivity, file_types_support)
VALUES (1, 'java19', 9, '.java, .jav, .JAVA, .JAV'),
       (2, 'python3', 12, '.py'),
       (3, 'c/c++', 12, '.cpp, .CPP, .cxx, .CXX, .c++, .C++, .c, .C, .cc, .CC, .h, .H, .hpp, .HPP, .hh, .HH'),
       (4, 'c#-1.2', 8, '.cs, .CS'),
       (5, 'char', 10, '.TXT, .txt, .ASC, .asc, .TEX, .tex'),
       (6, 'text', 5, '.TXT, .txt, .ASC, .asc, .TEX, .tex'),
       (7, 'scheme', 13, '.scm, .SCM, .ss, .SS'),
       (8, 'java17', 9, '.java, .jav, .JAVA, .JAV'),
       (9, 'java15', 8, '.java, .jav, .JAVA, .JAV'),
       (10, 'java12', 9, '.java, .jav, .JAVA, .JAV'),
       (11, 'java11', 9, '.java, .jav, .JAVA, .JAV');
