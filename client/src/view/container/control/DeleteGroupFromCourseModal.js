...
import {deleteGroupFromCourse} from "../../../api/group";

class DeleteGroupFromCourseModal extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            courseId: -1,
    ...
    async handleSubmit() {
        try {
            ...
            await deleteGroupFromCourse(this.state.courseId, this.state.groupId);
            this.handleCloseBtn();
                    ...
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title">
                                Видалення групи "{this.props.activeGroup.name}"
                            </h4>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(DeleteGroupFromCourseModal));
